...
should be a hashref with the following entries:
...
If, instead of a hashref, this entry is a single string then it should be
interpreted as a URL that points to some source control resource of undermined
nature.
